package com.spring.Job_portal.model;

import jakarta.persistence.*;

@Entity
@Table(name = "job_portal", uniqueConstraints = @UniqueConstraint(columnNames = "email"))
public class JobModel {
    ...
    public JobModel(String fullName, String email, Long phno, String qualification, String branch, Long passed_out,
